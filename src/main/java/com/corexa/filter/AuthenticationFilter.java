...
public class AuthenticationFilter implements Filter {
    ...
    private static final String ADMIN_MONTHLY_REPORT = "/admin/reports/monthly-sales";
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (isLoggedIn) {
        	userRole = (String) SessionUtil.getAttribute(req, "role");
	        if ("admin".equals(userRole)) {
				...
				if (uri.endsWith(LOGIN) || uri.endsWith(REGISTER)) {
					res.sendRedirect(req.getContextPath() + ADMIN_DASHBOARD);
						...
						|| uri.endsWith(ORDERS) || uri.endsWith(ADMIN_MONTHLY_REPORT) || uri.endsWith(HOME) || uri.endsWith(ROOT)
				...
				if (uri.endsWith(LOGIN) || uri.endsWith(REGISTER)) {
					...
					chain.doFilter(request, response);
						...
						|| uri.endsWith(ORDERS) || uri.endsWith(ADMIN_MONTHLY_REPORT)) {
					res.sendRedirect(req.getContextPath() + HOME);
				} else {
					res.sendRedirect(req.getContextPath() + HOME);
				}
