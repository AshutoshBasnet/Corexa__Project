...
public class RegisterService {
	...
	public RegisterService() {
		try {
            ...
            DataBaseSchemaUtil.ensureAccountStatusColumn(this.dbConn);
	...
	public Boolean addUser(UserModel userModel) {
        ...
        try {
            ...
            boolean withApprovalStatus = hasAccountStatusColumn();
            if (!withApprovalStatus) {
                System.err.println("Account approval column is not available.");
                return null;
            }
            String insertQuery = "INSERT INTO user (first_name, last_name, username, dob, gender, email, number, password, address_id, profilePic, account_status) "
                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            try (PreparedStatement addressStmt = dbConn.prepareStatement(addressQuery);
                ...
                insertStmt.setString(11, "PENDING");
