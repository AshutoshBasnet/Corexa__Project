...
public class OrderService implements AutoCloseable {
    ...
    private OrderModel createOrderRecord(CartModel cart, String paymentMethod) throws SQLException {
        ...
        String sql = withDateTime
                ? "INSERT INTO order_table (user_id, cart_id, order_date, order_datetime, order_status, paymentMethod) VALUES (?, ?, ?, ?, ?, ?)"
                : "INSERT INTO order_table (user_id, cart_id, order_date, order_status, paymentMethod) VALUES (?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement stmt = dbConn.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            if (withDateTime) {
                ...
                stmt.setString(5, ORDER_STATUS_PROCESSING);
